...
public class MusicPlayer {
    ...
    @FindBy(xpath = "(//android.widget.ImageView[@resource-id=\"com.example.android.uamp.next:id/item_state\"])[3]")
    private WebElement playButton;

    @FindBy(xpath = "//android.widget.TextView[@resource-id=\"com.example.musicplayer:id/song_status\"]")
